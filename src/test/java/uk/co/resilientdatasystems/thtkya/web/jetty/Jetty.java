package uk.co.resilientdatasystems.thtkya.web.jetty;
...
import uk.co.resilientdatasystems.thtkya.config.WebConfig;
...
public class Jetty {
    ...
    public static Server createStartedServer() throws Exception {
        assignPropertyDefault("spring.profiles.active", "production");
    ...
    private static WebAppContext createWebapp() throws Exception {
        ...
        webApp.setConfigurations(new Configuration[] { new AnnotationConfiguration() {
            ...
            public void preConfigure(WebAppContext context) throws Exception {
                Set<String> implementations = new ConcurrentHashSet<>();
