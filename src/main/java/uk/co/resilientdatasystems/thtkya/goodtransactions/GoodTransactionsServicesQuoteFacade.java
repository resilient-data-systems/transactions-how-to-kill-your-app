...
@Transactional
public class GoodTransactionsServicesQuoteFacade implements QuoteFacade {

    private final QuoteService quoteService;
    private final StatsService statsService;

    @Autowired
    public GoodTransactionsServicesQuoteFacade(@Qualifier("GoodTransactions") QuoteService quoteService,
            @Qualifier("GoodTransactions") StatsService statsService) {
